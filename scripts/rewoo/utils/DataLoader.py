...
class DataLoader:
    ...
    def load_hotpot_qa(self, cache_dir="data/hotpot", sample_size=100, type="test"):
        assert type in ["train", "validation", "test"]
        # datapath = "data/hotpot/hotpot_qa/fullwiki/1.0.0/133b9501f892e5193babbad937bee3b4899deb4691ef4d791e6ac0111c875bb5"
